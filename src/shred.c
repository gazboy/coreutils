  ...
  patterns[] =
{
  ...
  2, 0x555, 0xAAA,		/* 2-bit */
  -1,				/* 1 random pass */
  6, 0x555, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA,	/* 3-bit */
  12, 0x555, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA,
  0x555, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA,	/* 4-bit */
  -1,				/* 1 random pass */
        /* The following patterns have the frst bit per block flipped */
  8, 0x555, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA,
  14, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA,
  0x555, 0xAAA, 0x555, 0xAAA, 0x555, 0xAAA, 0x555,
  -1,				/* 1 random pass */
  0				/* End */
};
